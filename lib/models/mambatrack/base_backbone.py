...
from lib.models.mambatrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def forward_features(self, z, x):
        ...
        t_rgb +=  self.pos_embed_z
        s_rgb += self.pos_embed_x
        t_X += self.pos_embed_z
        s_X += self.pos_embed_x
