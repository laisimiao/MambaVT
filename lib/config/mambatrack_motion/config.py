...
cfg.MODEL.BACKBONE.CONCAT_MODE = 'tsts'  # tsts: t_rgb, s_rgb, t_X, s_X  | ttss: t_rgb, t_X, s_rgb, s_X
cfg.MODEL.BACKBONE.Z_SEG = False  # add template segment embedding (as multiple templates)
cfg.MODEL.BACKBONE.ADD_CLS_TOKEN = False
cfg.MODEL.BACKBONE.ADD_MOTION_PRED = False
cfg.MODEL.BACKBONE.PROMPT_EMBED_TYPE = "vocab"  # sam vocab
...
# DATA
cfg.DATA = edict()
cfg.DATA.PRE_MOTION_NUM = 0
cfg.DATA.REVERSE_PROB = 0.0  # reverse video-level training augmentation
...
cfg.TEST.TEST_PRE_NUM = edict()
cfg.TEST.TEST_PRE_NUM.GTOT = 6
cfg.TEST.TEST_PRE_NUM.RGBT210 = 6
cfg.TEST.TEST_PRE_NUM.RGBT234 = 6
cfg.TEST.TEST_PRE_NUM.LasHeR = 6
