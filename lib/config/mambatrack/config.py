...
cfg.MODEL.BACKBONE.SCAN_MODE = 'spatial_first'  # spatial_first   temporal_first
cfg.MODEL.BACKBONE.Z_SEG = False  # add template segment embedding (as multiple templates)
cfg.MODEL.BACKBONE.Z_VOCAB_SIZE = 200  # 
...
# DATA
cfg.DATA = edict()
cfg.DATA.REVERSE_PROB = 0.0  # reverse video-level training augmentation < this
cfg.DATA.SAMPLER_MODE = "causal"  # uniform sampling methods
